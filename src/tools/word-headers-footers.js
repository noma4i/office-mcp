...
export const headerFooterTools = [
  {
    ...
    inputSchema: {
      ...
      properties: {
        section: {
          type: 'integer',
          description: 'Section number (1-based, default: 1)',
          default: 1
        },
        type: {
          type: 'string',
...

  {
    ...
    inputSchema: {
      ...
      properties: {
        text: {
          type: 'string',
          description: 'Text to set as header content'
        },
        section: {
          type: 'integer',
          description: 'Section number (1-based, default: 1)',
...

  {
    ...
    inputSchema: {
      ...
      properties: {
        text: {
          type: 'string',
          description: 'Text to set as footer content'
        },
        section: {
          type: 'integer',
          description: 'Section number (1-based, default: 1)',
...

  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        width: {
          type: 'number',
          description: 'Optional width in points to resize the image'
        },
        height: {
          type: 'number',
          description: 'Optional height in points to resize the image'
        }
      },
      required: ['path']
    },
